...
export const _notifications = [...Array(9)].map((_, index) => ({
  ...
  title:
    (index === 0 && `<p><strong>Deja Brady</strong> Buy IoT Data Sets</p>`) ||
    (index === 1 &&
      `<p><strong>Jayvon Hull</strong> Buy Financial Data Sets </p>`) ||
    (index === 2 &&
      `<p><strong>Lainey Davidson</strong> Buy Agricultural Data Sets </p>`) ||
    (index === 3 &&
      `<p><strong>Angelique Morse</strong> Buy Telecommunications Data Sets</p>`) ||
    (index === 4 &&
      `<p><strong>Giana Brandt</strong> Buy Energy Data Sets</p>`) ||
    (index === 5 && `<p>Your order is placed waiting for transactions</p>`) ||
    (index === 6 && `<p>Delivery processing your data is being shipped</p>`) ||
